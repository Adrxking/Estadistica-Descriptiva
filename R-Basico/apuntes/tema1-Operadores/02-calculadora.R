...
# Para obtener 10 dígitos en el resultado
print(sqrt(2),10)
...
ceiling(sqrt(2))
# Igual que el floor pero se puede con negativos
trunc(sqrt(2))

sqrt(2)^2-2 # = 4.440892e-16 = 0.00000000000000000444
round(sqrt(2), 4)^2 # = 0

2^50
# 16 decimales es el máximo de numeros exactos, de 16 a 22 se redondea
print(2^50, 15)
print(2^50, 2)
# 22 es el máximo
print(pi, 22)
#3.141592653589793115998 --> Redondeado
#3.141592653589793238462 --> Real
